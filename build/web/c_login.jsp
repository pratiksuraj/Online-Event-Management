<%-- 
    Document   : c_login
    Created on : Jul 30, 2017, 8:50:39 AM
    Author     : PRATIK SURAJ
--%>
...
<form method="post" action="c_booking_details.jsp">
<br><br> <h2>
 <table border="0" cellspacing="25" cellpadding="20">
     
    
    <tr>
    <td>Please click here to view the details of Booked Venue:</td><td>
